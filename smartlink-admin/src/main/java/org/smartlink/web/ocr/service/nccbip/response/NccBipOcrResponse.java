...
public class NccBipOcrResponse {
    ...
    @JsonProperty("data")
    private NccBipOcrResponse.OneDataDTO data;
    ...
    public static class OneDataDTO {
        ...
        private String code;
        @JsonProperty("datas")
        private List<NccBipOcrResponse.OneDataDTO.DatasDTO> datas;
        @JsonProperty("msg")
        private String msg;
        ...
        public static class DatasDTO {
            ...
            @JsonProperty("data")
            private NccBipOcrResponse.OneDataDTO.DatasDTO.DataDTO data;
            ...
            public static class DataDTO {
                ...
                @JsonProperty("items")
                private List<NccBipOcrResponse.OneDataDTO.DatasDTO.DataDTO.ItemsDTO> items;
                /**
                 * 开票日期
                 */
                @JsonProperty("date")
                ...
                private List<NccBipOcrResponse.OneDataDTO.DatasDTO.DataDTO.ItemListDTO> itemList;
                /**
                 * 燃油附加费
                 */
                ...
                public static class ItemsDTO {
                    ...
                    private NccBipOcrResponse.OneDataDTO.DatasDTO.DataDTO.ItemsDTO.DetailMotorDTO detailMotor;
