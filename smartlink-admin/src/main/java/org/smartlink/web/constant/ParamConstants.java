...
public interface ParamConstants {
     ...
     * 附件是否使用外围系统预览
     */
    String SYS_FILE_VIEW="sys_file_view";
    /**
     * 附件外围系统预览url
     */
    String SYS_FILE_VIEW_URL="sys_file_view_url";
    /**
     * 是否必须上传电子发票源文件
     */
    ...
    /**
     * 暂存态发票不参与校验重复 true开启, false不开启
     */
    String INVOICE_IS_STAGING="invoice_is_staging";
     ...
     * 文件名长度限制
     * */
    String DOC_NAME_LENGTH="doc_name_length";

    /**
     * 是否调用NCC2111客开电子发票接口
     */
    String ELECTRONIC_INVOICE_2111_SERVICE_OFF = "electronic_invoice_2111_service_off";

    /**
     * 发票检索
     */
    String INVOICE_RETRIEVAL="invoice_retrieval";
}
