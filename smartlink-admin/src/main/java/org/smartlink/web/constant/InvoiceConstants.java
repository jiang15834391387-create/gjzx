package org.smartlink.web.constant;
...
public class InvoiceConstants {
     ...
     * 非税收入统一票据
     * */
    public static final String FINANCE = "127";

    /**
     * 海关进口增值税专用缴款书
     */
    public static final String INVOICE_CUSTBOOK_NCC = "141";
    /**
     * 全电普通发票
     */
    public static final String INVOICE_ELECTRIC_UNIVERSAL_TICKET_NCC = "143";
    /**
     * 全电专用发票
     */
    public static final String INVOICE_ELECTRIC_SPECIAL_TICKET_NCC = "144";
     ...
     * 海关进口增值税
     */
    public static final String  CUSTOMS = "141";
    ...
    public static final HashMap<String,String> BIP_INVOICE_TYPE_ENUM = new HashMap<>();

    public static List<String> getInvoiceType(){
        return Arrays.asList(InvoiceConstants.TAX_SPECIAL_INVOICE, InvoiceConstants.TAX_INVOICE, InvoiceConstants.ELECTRONIC_INVOICE, InvoiceConstants.ELECTRONIC_OFD_INVOICE, InvoiceConstants.ELECTRONIC_INVOICE_ITINERARY,InvoiceConstants.ELECTRONIC_INVOICE_QUKUAILIAN,InvoiceConstants.ROLL_TICKET);
    }
    ...
    static {
        ...
        INVOICE_ClASS_TYPE.put(FINANCE,"com.datafly.common.domain.invoice.DataOcrInfo");
        //区块链
        INVOICE_ClASS_TYPE.put(ELECTRONIC_INVOICE_QUKUAILIAN,"com.datafly.common.domain.invoice.DataOcrInfo");
        INVOICE_ClASS_TYPE.put(INVOICE_ELECTRIC_UNIVERSAL_TICKET_NCC,"com.datafly.common.domain.invoice.DataOcrInfo");
        INVOICE_ClASS_TYPE.put(INVOICE_ELECTRIC_SPECIAL_TICKET_NCC,"com.datafly.common.domain.invoice.DataOcrInfo");
        ...
        INVOICE_ClASS_TYPE.put(CUSTOMS,"com.datafly.common.domain.invoice.DataCustomsInvoice");

        BIP_INVOICE_TYPE_ENUM.put(QUOTA_INVOICE,"定额发票");
        BIP_INVOICE_TYPE_ENUM.put(AIRCRAFT_INVOICE,"通用机打发票");
        BIP_INVOICE_TYPE_ENUM.put(TAXI_TICKETS,"出租车发票");
        BIP_INVOICE_TYPE_ENUM.put(RAILWAY_TICKET,"火车票");
        BIP_INVOICE_TYPE_ENUM.put(PASSENGER_TICKET,"客运汽车票");
        BIP_INVOICE_TYPE_ENUM.put(FLIGHT_ITINERARY,"航空运输电子客票行程单");
        BIP_INVOICE_TYPE_ENUM.put(STEAMER_TICKET,"船票");
        BIP_INVOICE_TYPE_ENUM.put(TOLL_ROADS,"过路费");
        BIP_INVOICE_TYPE_ENUM.put(RECEIPT,"小票");
        BIP_INVOICE_TYPE_ENUM.put(DIDI_ITINERARY,"滴滴出行行程单");
        BIP_INVOICE_TYPE_ENUM.put(DUTY_PAID_PROOF,"完税证明");
