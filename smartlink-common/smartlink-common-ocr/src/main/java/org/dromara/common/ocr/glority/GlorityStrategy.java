package org.dromara.common.ocr.glority;
...
import org.dromara.common.ocr.abstractd.AbstractOcrStrategy;
import org.dromara.common.ocr.abstractd.ConversionFactory;
import org.dromara.common.ocr.constant.InvoiceConstants;
import org.dromara.common.ocr.entity.IdentificationData;
import org.dromara.common.ocr.exception.OcrException;
import org.dromara.common.ocr.glority.config.GlorityOcrProperties;
...
public class GlorityStrategy extends AbstractOcrStrategy {
    ...
    public void init(OcrProperties properties) {
        ...
        try {
            glorityOcrProperties = objectMapper.readValue(this.properties.getDetailInfo(),GlorityOcrProperties.class);
