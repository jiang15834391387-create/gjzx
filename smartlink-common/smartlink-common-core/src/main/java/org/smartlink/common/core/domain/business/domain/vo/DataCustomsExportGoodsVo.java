...
/**
 * 海关出口货物视图对象 data_customs_export_goods
 *
 * @author Lion Li
 * @date 2025-01-08
 */
...
@AutoMapper(target = DataCustomsExportGoods.class)
public class DataCustomsExportGoodsVo implements Serializable {
     ...
     * 境外收货人-编号
     */
    @ExcelProperty(value = "境外收货人-编号")
    private String overseasConsigneeCode;

    /**
     * 境外收货人-名称
     */
    @ExcelProperty(value = "境外收货人-名称")
    private String overseasConsigneeName;

    /**
     * 出境关别-编号
     */
    @ExcelProperty(value = "出境关别-编号")
    private String portOfExportCode;

    /**
     * 出境关别-名称
     */
    @ExcelProperty(value = "出境关别-名称")
