...
import org.smartlink.common.core.domain.business.domain.DataCustomsExportGoods;
import org.smartlink.common.core.validate.AddGroup;
import org.smartlink.common.core.validate.EditGroup;
import org.smartlink.common.mybatis.core.domain.BaseEntity;

/**
 * 海关出口货物业务对象 data_customs_export_goods
 *
 * @author Lion Li
 * @date 2025-01-08
 */
...
@AutoMapper(target = DataCustomsExportGoods.class, reverseConvertGenerate = false)
public class DataCustomsExportGoodsBo extends BaseEntity {
     ...
     * 出口日期
     */
    @NotBlank(message = "出口日期不能为空", groups = { AddGroup.class, EditGroup.class })
     ...
     * 境外收货人-编号
     */
    @NotBlank(message = "境外收货人-编号不能为空", groups = { AddGroup.class, EditGroup.class })
    private String overseasConsigneeCode;

    /**
     * 境外收货人-名称
     */
    @NotBlank(message = "境外收货人-名称不能为空", groups = { AddGroup.class, EditGroup.class })
    private String overseasConsigneeName;

    /**
     * 出境关别-编号
     */
    @NotBlank(message = "出境关别-编号不能为空", groups = { AddGroup.class, EditGroup.class })
    private String portOfExportCode;

    /**
     * 出境关别-名称
     */
    @NotBlank(message = "出境关别-名称不能为空", groups = { AddGroup.class, EditGroup.class })
