package org.smartlink.common.entity.domain.business.constant;

public class InvoiceTypeConstants {
    /**
     * 增值税专用发票
     */
    public static final String GLORITY_TAX_SPECIAL_CODE = "10100";
    /**
     * 增值税电子专用发票
     */
    public static final String GLORITY_ELECTRON_TAX_SPECIAL_CODE = "10100_1";
    /**
     * 增值税普通发票
     */
    public static final String GLORITY_TAX_CODE = "10101";
    /**
     * 增值税电子普通发票
     */
    public static final String GLORITY_ELECTRONIC_CODE = "10102";
    /**
     * 区块链电子发票
     */
    public static final String GLORITY_ELECTRONIC_QUKUAILIAN_CODE = "10102_1";
    /**
     * 收费公路通行费增值税电子普通发票
     */
    public static final String GLORITY_ELECTRONIC_ROAD_TOLLS_CODE = "10102_2";
    /**
     * 增值税普通发票(卷票)
     */
     ...
     * 医疗票据
     */
    public static final String MEDICAL_RECEIPTS_CODE = "102021";
    /**
     * 增值税发票清单
     */
