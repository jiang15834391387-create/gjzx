 ...
 * @date 2025-01-08
 */
public interface IDataDutyPaidProofDetailsService {
     ...
     * @return 完税证明明细列表
     */
    List<DataDutyPaidProofDetailsVo> queryList(DataDutyPaidProofDetailsBo bo);
     ...
     * @return 是否新增成功
     */
    Boolean insertByBo(DataDutyPaidProofDetailsBo bo);
     ...
     * @return 是否修改成功
     */
    Boolean updateByBo(DataDutyPaidProofDetailsBo bo);
