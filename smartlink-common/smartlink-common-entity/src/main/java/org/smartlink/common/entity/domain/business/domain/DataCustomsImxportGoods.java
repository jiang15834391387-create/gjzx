...
/**
 * 海关进口货物报关单对象 data_customs_imxport_goods
 *
 * @author Lion Li
 * @date 2025-01-08
 */
...
@TableName("data_customs_imxport_goods")
public class DataCustomsImxportGoods extends TenantEntity {
    ...
    private List<DataCustomsImportGoodsDetail> details;
