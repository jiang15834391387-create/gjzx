...
public class InvoiceRecognitionController {
    ...
    @PostMapping("/upload")
    public R<DataImageFilesInfoVo> upload(@NotNull(message = "上传文件不能为空") @RequestParam("file") MultipartFile file) throws Exception {

        DataImageFilesInfoVo dataImageFilesInfoVo = scanImageService.uploadImage(file);
//        try{
...
//        String suffix = FilesUtils.getFileSuffix(dto.getFileName());
//        try {
//            //图片
