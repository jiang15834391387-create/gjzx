...
/**
 * 海关出口货物明细业务对象 data_customs_export_goods_detail
 *
 * @author Lion Li
 * @date 2025-01-08
 */
...
@AutoMapper(target = DataCustomsExportGoodsDetail.class, reverseConvertGenerate = false)
public class DataCustomsExportGoodsDetailBo extends BaseEntity {
     ...
     * 运抵国(地区)
     */
    @NotBlank(message = "运抵国(地区)不能为空", groups = { AddGroup.class, EditGroup.class })
