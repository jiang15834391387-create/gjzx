 ...
 * @create:
 **/
public class YesfpFactory implements IdentificationFactory<YesfpResultData> {
    ...
    @Override
    public ChangeIdentifyInfo conversionInfo(DataImageFilesInfo dataImageFilesInfo, YesfpResultData datasDTO)  {
        dataImageFilesInfo.setNcImageId(datasDTO.getImageId());
        switch (datasDTO.getBillType()) {
            ...
            default:
                ...
                return YesfpOthersConversion.getInstance();
        }
