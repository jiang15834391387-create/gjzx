...
import org.smartlink.server.nc.ncc.deleteocr.NccDeleteOcrService;
import org.smartlink.server.nc.ncc.deleteocr.request.allinvoice.DeleteAllInvoiceData;
import org.smartlink.server.nc.ncc.deleteocr.request.allinvoice.DeleteAllInvoiceRequest;
import org.smartlink.server.nc.ncc.deleteocr.request.allinvoice.DeleteElectronicInvoiceData;
import org.smartlink.server.nc.ncc.deleteocr.request.allinvoice.DeleteElectronicInvoiceRequest;
import org.smartlink.server.nc.ncc.deleteocr.request.taxinvoice.DeleteElectronicNonStandardRequest;
import org.smartlink.server.nc.ncc.deleteocr.request.taxinvoice.DeleteElectronicNonStandardRequestData;
import org.smartlink.server.nc.ncc.deleteocr.request.taxinvoice.DeleteTaxInvoiceData;
import org.smartlink.server.nc.ncc.deleteocr.request.taxinvoice.DeleteTaxInvoiceRequest;
import org.smartlink.server.nc.ncc.deleteocr.response.DeleteInvoiceResponse;
import org.smartlink.server.nc.ncc.nccor.NccOcrRecognitionService;
import org.smartlink.server.nc.ncc.nccor.dispose.NccAllDisposeInvoiceService;
import org.smartlink.server.nc.ncc.nccor.dispose.NccTaxDisposeInvoiceService;
import org.smartlink.server.nc.ncc.nccor.request.allinvoice.UploadElectronicInvoiceRequest;
import org.smartlink.server.nc.ncc.nccor.request.allinvoice.UploadElectronicInvoiceRequestData;
import org.smartlink.server.nc.ncc.nccor.request.taxinvoice.UploadElectronicInvoiceNonStandardRequest;
import org.smartlink.server.nc.ncc.nccor.response.allinvoice.UploadElectronicInvoiceResponse;
import org.smartlink.server.nc.ncc.nccor.response.taxinvoice.UploadElectronicInvoiceNonStandardResponse;
import org.smartlink.server.nc.ncc.nccor.response.taxinvoice.UploadElectronicInvoiceNonStandardResponseData;
