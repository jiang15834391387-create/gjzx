...
public class DataMotorVehicleSale extends BaseEntity {
     ...
     * 购买方税号
     */
    @FieldName(value="购买方税号")
    private String buyerId;
    /**
     * 车辆识别代码
     */
    @FieldName(value="车辆识别代码")
     ...
     * 合格证号
     */
    @FieldName(value="合格证号")
    private String certificateNumber;
    /**
     * 进口证明书号
     */
    @FieldName(value="进口证明书号")
     ...
     * 商检单号
     */
    @FieldName(value="商检单号")
    private String commodityInspectionNo;
    /**
     * 开票日期
     */
    @FieldName(value="开票日期")
     ...
     * 限乘人数
     */
    @FieldName(value="限乘人数")
    private Long limitedPeopleCount;
    /**
     * 机打代码
     */
    @FieldName(value="机打代码")
    private String machineCode;
    /**
     * 机打号码
     */
    @FieldName(value="机打号码")
     ...
     * 销售单位开户账号
     */
    @FieldName(value="销售单位开户账号")
    private String sellerBankAccount;
    /**
     * 销售单位开户银行
     */
    @FieldName(value="销售单位开户银行")
    private String sellerBankName;
    /**
     * 销售方手机号
     */
    @FieldName(value="销售方手机号")
     ...
     * 主管税务机关代码
     */
    @FieldName(value="主管税务机关代码")
    private String taxAuthoritiesCode;
    /**
     * 完税凭证号码
     */
    @FieldName(value="完税凭证号码")
