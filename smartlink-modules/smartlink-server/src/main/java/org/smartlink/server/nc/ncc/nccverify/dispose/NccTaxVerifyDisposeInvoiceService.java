package org.smartlink.server.nc.ncc.nccverify.dispose;
...
import org.smartlink.server.nc.ncc.nccstand.dispose.NccTaxStandDisposeInvoiceService;
import org.smartlink.server.nc.ncc.nccverify.NccTaxVerifyService;
import org.smartlink.server.nc.ncc.nccverify.request.VerifyTaxInvoiceRequest;
import org.smartlink.server.nc.ncc.nccverify.request.VerifyTaxInvoiceRequestData;
import org.smartlink.server.nc.ncc.nccverify.response.VerifyDataItem;
import org.smartlink.server.nc.ncc.nccverify.response.VerifyTaxInvoiceResponse;
import org.smartlink.server.nc.ncc.nccverify.response.VerifyTaxInvoiceResponseData;
import org.smartlink.server.nc.ncc.nccverify.response.VerifyTaxInvoiceResponseDataInvoice;
import org.smartlink.server.nc.ncc.syncocr.NccSyncTaxInvoiceService;
import org.smartlink.server.nc.ncc.syncocr.request.allinvoice.SyncAllInvoiceRequest;
import org.smartlink.server.nc.ncc.syncocr.request.taxinvoice.SyncTaxInvoiceRequest;
import org.smartlink.server.nc.ncc.syncocr.request.taxinvoice.SyncTaxInvoiceRequestData;
import org.smartlink.server.nc.ncc.syncocr.response.allinvoice.SyncAllInvoiceResponse;
import org.smartlink.server.nc.ncc.syncocr.response.taxinvoice.SyncTaxInvoiceResponse;
import org.smartlink.server.nc.properties.NccParamProperties;
import org.smartlink.server.nc.service.nc.IDataOcrInfoService;
...
import org.smartlink.server.nc.utils.MoneyUtil;
